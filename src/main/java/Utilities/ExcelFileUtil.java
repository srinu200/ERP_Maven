...
//constructor for accessing excel path
	...
	{
		FileInputStream fi = new FileInputStream(System.getProperty("user.dir")+"\\TestInput\\InputSheet.xls");
...
//writing results into cells
	public void setCellData(String sheetname, int row, int column, String status) throws Throwable
	{
		...
		FileOutputStream fo = new FileOutputStream(System.getProperty("user.dir")+"\\TestOutput\\HybridOutput.xls");
		wb.write(fo);
		fo.close();
